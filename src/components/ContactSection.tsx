      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">
            Ready to start your aluminum project? Contact us for a consultation and free quote.
          </p>
        </div>
          ...
          <div className="space-y-8">
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Send us your project details</p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Serving all regions</p>
              </div>
            </div>
            ...
            <form className="space-y-6">
              ...
              <div>
                ...
                <textarea 
                  rows={4}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                  placeholder="Tell us about your aluminum project requirements..."
                ></textarea>
              </div>
